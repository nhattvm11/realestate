...
import com.project.realestate.helper.DeviceProvider;
...
public class ProtectedLoginController {
    ...
    @PostMapping("/login")
    public String handleLogin(@RequestParam String username, @RequestParam String password, HttpServletRequest request, HttpServletResponse httpServletResponse) throws UserNotFoundException {
        ...
        return "redirect:/api/v1/public/users/"+user.getId();
    }
}
