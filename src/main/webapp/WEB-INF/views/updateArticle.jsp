...
<form:form id="formUpdate" method="post"  modelAttribute="article">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <label class="control-label col-md-2">Slide Image</label>
            <div class="col-md-10">
                <c:forEach items="${article.pictures}" var="pic">
                    <p>
                    <div class="img-thumbnail">
                        <a class="removepicture close" href="#" pid="${pic.id}">X</a>
                        <img src="/realestate${pic.url}" width="100" height="80" />
                    </div>
                    </p>
                </c:forEach>
            </div>
    ...
    <div class="panel panel-default col-md-10">
        <div class="panel-body">
            <div>
                ...
                <hr>
                <button id="update-button" class="btn btn-primary" type="submit">
                    <span class="glyphicon glyphicon-plus"></span> Edit Article
                </button>
            </div>
        </div>
    </div>
